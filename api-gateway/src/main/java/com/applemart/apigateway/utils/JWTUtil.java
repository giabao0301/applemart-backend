package com.applemart.apigateway.utils;
...
public class JWTUtil {
    ...
    public String issueToken(String subject, Map<String, Object> claims) {
        ...
        JWTClaimsSet.Builder claimsSetBuilder = new JWTClaimsSet.Builder()
                ...
                .expirationTime(new Date(
                        Instant.now().plus(10, MINUTES).toEpochMilli()
                ));
    ...
    public String issueRefreshToken(String subject, String... scopes) {
        return issueRefreshToken(subject, Map.of("scopes", scopes));
    }
    ...
    public String extractSubject(String token) throws JOSEException, ParseException {
        SignedJWT signedJWT = SignedJWT.parse(token);
